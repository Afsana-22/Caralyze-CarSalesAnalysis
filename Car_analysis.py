...
if st.session_state.page == "predict_price":
    ...
    with col1:
        ...
        st.markdown('<div class="small-year-input">', unsafe_allow_html=True)
        year = st.number_input("Select Year for Prediction", min_value=2023, max_value=2030, value=2025, key="year_small")
